...
no_texas_filtered_data <- filtered_data[no_texas_filtered_data$Dose1Pct!=0,]
...
write.csv(no_texas_filtered_data, "./processed_data/Selected_Data_V2.csv")

```
```{r}
no_texas_filtered_data
```
