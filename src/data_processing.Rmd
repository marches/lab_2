...
education
```
Car, Education and Vaccination data is already formatted, just rename County column for consistency
```{r}
cars <- cars %>%
...
```
Remove all whitespace from County.Name.Filt.On columns
```{r}
