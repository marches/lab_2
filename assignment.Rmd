...
Suppose that your team is interested in craft-beer tourism, *big-business* in parts of the United States. A starting place for your investigation might be collecting information and data about the industry over the past several years, then inductively examining the impacts of both covid-19 and master's degree enrollment on beer-tourism. Analysis at this level is not specific enough to be generate actions from a model; your team will have to continue to refine your focus to propose a specific question. 

After coming to understand the landscape, you and your team might propose the following research question: *"What are the effects of subsidies that reduce the cost of rent for craft-breweries to rent warehouse space?"* The team might reason that such subsidies should increase the number of breweries in operation, the number of barrels of craft-beer brewed within the subsidized geography, and should also increase the number of Airbnb listings and carshare rides in the area of the subsidies.
