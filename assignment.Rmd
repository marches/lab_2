...
Suppose that your team is interested in craft-beer tourism (this is *big-business* in parts of the United States). A starting place for your investigation might be collecting information and data about the industry over the past several years, then inductively examining the impacts of both covid-19 and master's degree enrollment on beer-tourism. Analysis at this level is not specific enough to be actional by a model, and so your team will have to continue to refine your focus to propose a specific question. 

After coming to understand the landscape, you and your team might propose the following research question: *What are the effects of subsidies that reduce the cost of rent for craft-breweries to rent warehouse space?"* The team reasons that such subsidies should increase the number of breweries in operation, the number of barrels of craft-beer brewed within the subsidized geography, and should also increase the number of Airbnb listings and carshare rides in the area of the subsidies.
...
Because of the limitations of models we have studied in the course, we recommend that data for analysis be aggregated to either the state- or county-level. In w203 we have not dealt with *time* in any way. While your descriptive analysis might show plots of outcomes that vary over time, models that have repeated observations through time should likely be avoided. (If the team can marshal time-series tools, they are not prohibited from doing so, but these tools are beyond the scope of the course.) 
