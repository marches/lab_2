---
title: "Lab 2: Vacations and Tourism in Summer 2021"
...
**Your task is to select and develop a research question, then conduct a regression study to analyze it.** Your research question must focus attention on a *specific* question or goal. For this, you will have to use the skills you have developed in RDADA to work on a question that can be addressed using a modeling approach. It is not enough to say "we are examining how policies affect tourism", or "we are examining how covid has affected tourism"; both of these types of questions are not amenable to a modeling based approach and would likely generate a fishing expedition. Instead, you and the team will have to use your understanding of, intuition about, and data from the world to propose a question and generate an answer. 

For example, your team might be interested in craft-beer tourism (this is *big-business* in parts of the United States). A starting place for your investigation might be collecting information and data about the industry over the past several years, then examining the impacts of both covid-19 and master's degree enrollment on individual's interest in beer-tourism, and then proposing *and evaluating* specific models in pursuit of your goal. As an example, after coming to understand the landscape, you and your team might evaluate a policy that subsidizes rent on warehouse space for [https://www.ghosttownbrewing.com](craft-breweries) to use for brewing and retail.
...
Because of the limitations of models we have studied in the course, we recommend that data for analysis be aggregated to either the state- or county-level. Also, note that in the course we have not dealt with *time* in any way. Descriptive statistics 
...
- [COVID-19 Community Mobility Report](https://www.google.com/covid19/mobility/) A dataset collected by Google that includes state-level measurements of individual mobility, by categeory (e.g. )
...
The research question should be informed by an understanding of the datasets that are available, and the data that is available in those data sets. This means that the the team will need to have done at least preliminary work understand what data is available. A motivated team might form their research question, and begin to build a functioning data pipeline as an investment in ongoing project success. This proposal is intended to provide a structure for the team to have early conversations; it will be graded credit/no credit for completeness (i.e. a reasonable effort by the team will receive full marks). 
...
**This reflection is due in week 13, an requires one submission per person.** You will submit this through Gradescope, and like all parts of your educational record, this will be treated confidentially by the instructional team. 
