...
While the size of our dataset (over 2,900 individual data points) is large enough to satisfy ----, we complete an analysis of as an exercise. The most interesting/relevant assumptions are highlighted below. 
