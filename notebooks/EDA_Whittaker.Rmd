...
```{r}
#Plot USA trips
plot_usmap("counties", data=data, values = "TripsOver250PerCap", exclude = c("AK", "HI")) +
...
```{r}
#Plot California
plot_usmap("counties", include = c("CA"), data = data, values = "TripsOver250PerCap") +  ggplot2::scale_fill_continuous(low = "light blue", high = "dark blue", name = "Trips over 250 miles per capita") +
  theme(legend.position = "right")
